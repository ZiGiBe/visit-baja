<script lang="ts">
    ...
    async function Download(){
        ...
        hidden.href = URL.createObjectURL(new Blob([await axios.get('http://185.75.194.239:8080/media/'+block.data.file.filename, {
            responseType: "blob"
        })]));
...
<div class="file">
    <a target="_blank" href={'http://185.75.194.239:8080/media/'+block.data.file.filename}>
